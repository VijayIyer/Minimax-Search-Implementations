...
def EvaluateState(State, player):
    ...
    if player == 'b':
        return len(State.b_pieces) - len(State.w_pieces) + 0.2 * (strength_b - strength_w) + 0.02 * sum(
        ...
        return len(State.w_pieces) - len(State.b_pieces) + 0.2 * (strength_w - strength_b) + 0.02 * sum(
